...
export default function Custom404() {
  return (
    <div className="container mx-auto flex justify-center items-center flex-col min-h-screen p-4">
      <div className="text-center">
        <svg
          className="text-center mx-auto mb-10 w-full"
          width="483"
          height="300"
          viewBox="0 0 483 300"
          fill="none"
      ...
      <h2 className="text-4xl font-bold text-center text-heading mb-5">
        Oops! Not Found
      </h2>
      <p className="text-lg text-center text-font-primary-400 m-0">
        Halaman yang anda kunjungi tidak ditemukan
      </p>
      <div className="w-full sm:w-1/2 lg:w-1/4 mt-10">
