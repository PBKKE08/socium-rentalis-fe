...
export default function PaymentComplete() {
  return (
    <>
      <Head>
        <title>Socium Rentalis | Payment Success</title>
      ...
      <main>
        ...
        <div className="pt-20 pb-20 px-4 container mx-auto">
          ...
          <div className="flex flex-col justify-center items-center">
            <h1 className="text-3xl font-bold text-center mt-10 mb-5 text-heading">
              Payment Success
            </h1>
            <p className="text-center text-body text-font-primary-400 mb-10">
              Your payment has been successfully processed. <br /> We will check
              your payment and send you a confirmation via WhatsApp.
            </p>
            <Button
              isPrimary
              href="/transaction/upcoming"
              className="md:w-1/2 lg:w-1/4 mb-3"
            >
              Go to Transaction
            </Button>
            <Button className="md:w-1/2 lg:w-1/4">WhatsApp Admin</Button>
          </div>
        </div>
